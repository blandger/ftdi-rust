...
mod tests {
    ...
    fn parse_vendor_product_index_fail() {
        let values: Vec<(&str, std::result::Result<std::vec::Vec<u16>, FtdiError>)> = vec![
            ...
            (":empty", Err(FtdiError::UsbCommonError{code: -12,
                message:"incorrect 'description' format, vendor and product is minimal set".to_string()})),
            ("s:1234", Err(FtdiError::UsbCommonError{code: -12,
                message:"incorrect 'description' format, vendor and product is minimal set".to_string()})),
            ("s:0o400:0x4DF:0x0:dddd", Err(FtdiError::UsbCommonError{code: -14,
                message:"incorrect 'description' format is too long".to_string()})),
            ("i:0xFFFFF:0x4DF:0x0", Err(FtdiError::UsbCommonError{code: -15,
                message:"HEX value parse error".to_string()})),
            ("i:0xFF:0x4DsdhF:0x0", Err(FtdiError::UsbCommonError{code: -15,
                message:"HEX value parse error".to_string()})),
            ("s:0o8800:0o123:0o0", Err(FtdiError::UsbCommonError{code: -16,
                message:"Octal value parse error".to_string()})),
            ("s:0o56:0o123678:0o0", Err(FtdiError::UsbCommonError{code: -16,
                message:"Octal value parse error".to_string()})),
            ("i:657777:0x4DF:0x0", Err(FtdiError::UsbCommonError{code: -17,
                message:"Decimal value parse error".to_string()})),
            ("i:657777:0x4DF:0x0", Err(FtdiError::UsbCommonError{code: -17,
                message:"Decimal value parse error".to_string()})),
            ("i:657:67000:0", Err(FtdiError::UsbCommonError{code: -17,
                message:"Decimal value parse error".to_string()})),
            ("i:657:600:0789056", Err(FtdiError::UsbCommonError{code: -17,
                message:"Decimal value parse error".to_string()})),
            ("s:124:", Err(FtdiError::UsbCommonError{code: -17,
                message:"Decimal value parse error".to_string()})),
        ];
        for (input, expected) in values {
            println!("input = \'{}\'", input);
